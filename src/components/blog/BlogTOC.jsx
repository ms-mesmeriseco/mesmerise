      ...
      <div className="relative w-fit self-start mb-8">
        ...
        >
          {anchors.map((anchor) => (
            <div
              key={anchor.id}
              className="border-[var(--mesm-grey-dk)] border-1 rounded-xs px-2 py-2 text-left text-sm text-[var(--foreground)] hover:text-[var(--background)] hover:bg-[var(--foreground)] duration-200 flex flex-row items-start gap-2"
            >
