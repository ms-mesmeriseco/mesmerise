...
export default function ExpandingCard({
  ...
  return (
    <div
      className="flex flex-col  bg-[var(--mesm-grey-dk)]/10 border-[var(--mesm-grey-dk)] border-1 py-4 px-8 rounded-xl shadowtransition duration-200 hover:border-[var(--mesm-blue)]"
      {...props}
    >
      <button
