  ...
  return (
    <InView>
      <section className="wrapper flex flex-col gap-[var(--global-margin-lg)] min-h-[80vh] justify-center">
        ...
        <motion.div className="grid grid-cols-1 md:grid-cols-2 overflow-y-auto max-h-[70vh] px-[var(--global-margin-xs)] py-[var(--global-margin-sm)] gap-18 text-base leading-relaxed">
