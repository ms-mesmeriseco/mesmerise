...
export default function ServiceTags({
  ...
  const tagSize = [
    large
      ...
      : "rounded-lg px-3 py-0 text-md hover:text-[var(--mesm-grey)] hover:bg-[var(--background)] border-1 border-[var(--mesm-grey-dk)] bg-[var(--mesm-red)] text-[var(--background)] duration-200",
  ];
