...
export default function Header() {
  ...
  const timeoutRef = useRef(null); // <-- plain JS ref (no generics)
  const headerRef = useRef(null); // <-- plain JS ref (no generics)
      ...
      {isVisible && (
        <motion.header
          ...
          className="site-header fixed z-50 w-full box-border
                     grid grid-cols-[1fr_auto_1fr] items-center p-4 border-[var(--mesm-grey)]  bg-[var(--background)] shadow-xl"
        >
          ...
          >
            ...
            <div className="">
              <svg
                className="h-[2.23rem] fill-[var(--foreground)]"
