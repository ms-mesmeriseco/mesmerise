...
export default function PageBase({ blocks }) {
  ...
  return (
    <motion.div
      {...anim(opacity)}
      className="flex flex-col items-center justify-center min-h-screen mb-[10rem] md:p-[var(--global-margin-md)] sm:p-[var(--global-margin-lg)] md:mt-[var(--header-height)] pt-18"
    >
      <main className="wrapper grid grid-cols-12 flex flex-col lg:gap-y-[6rem] md:gap-y-[4rem] gap-y-[4rem] w-full">
