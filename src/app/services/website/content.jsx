export const heroMedia = "/assets/highlights/Website_v3-comp.mp4";
...
export const servicesFAQ = [
  ...
  },
  {
    ...
    textContent:
      "Yes. Every website we deliver is responsive across all devices, technically optimised for SEO, and built with conversion psychology in mind. That means fast load speeds, clean code, and strategically placed calls-to-action.",
  },
  {
    question:
  ...
  },
  {
    ...
    textContent:
      "Yes, you approve the design before we start to build out the website. <br/><br/>We design wireframes via Figma, which gives you a clear visual of how the website will look and feel. Only once you approve the designs, we start building.",
  },
  {
