...
export default function HomePage() {
  ...
  return (
    <div className="relative">
      ...
      <div className="pr-[var(--global-margin-xs)] flex flex-col gap-[var(--global-margin-md)]">
        <HeroBlock />
        <AboutSection />
        <ProjectScroll />
        <ServicesList />
        ...
        <section
          data-marker="say hi"
          className="flex flex-col items-center justify-center gap-[var(--global-margin-lg)] p-[var(--global-margin-lg)] w-[80vw] m-auto h-[60vh]"
        >
